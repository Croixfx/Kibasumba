...
//
// TODO: replace with live MINISANTE API data on integration.
// This mirrors frontend/lib/data/rwanda_locations.dart — keep the two in
// sync until the MINISANTE API replaces both.
...
export const hospitalsByDistrict = {
  // Kigali City
  Gasabo: [
  ...
  Kicukiro: ['Rwanda Military Hospital (Kanombe)', 'Masaka District Hospital'],
  Nyarugenge: [
